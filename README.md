...
developed as a collection of automations and skills using Microsoft Scout. **LISA's skills are
currently built and tested for use only with Microsoft Scout.** LISA can autonomously turn customer
